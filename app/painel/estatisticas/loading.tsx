export default function LoadingDesempenho() {
  return <main className="min-h-screen bg-slate-50 p-4 sm:p-8"><div role="status" className="mx-auto max-w-6xl">
    ...
    <div aria-hidden="true" className="mt-6 grid grid-cols-2 gap-3 lg:grid-cols-4">{[0, 1, 2, 3].map(i => <div key={i} className="h-28 motion-safe:animate-pulse rounded-2xl bg-white" />)}</div>
    <div aria-hidden="true" className="mt-8 h-80 motion-safe:animate-pulse rounded-3xl bg-white" />
  </div></main>
}
