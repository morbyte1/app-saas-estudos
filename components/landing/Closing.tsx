...
export function Insights() {
  return <section className="bg-[#14251f] px-5 py-24 sm:px-8 lg:py-32" aria-labelledby="insights-title">
    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
      <div>
        ...
        <p className="mt-8 border-l-2 border-[#C2A83E] pl-5 text-lg font-medium text-[#E0EEC6]">O Revyza encontra sinais. Você continua tomando as decisões.</p>
      </div>
      <div className="self-center rounded-[28px] border border-[#E0EEC6]/15 bg-[#1d332a] p-6 sm:p-8">
        <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#F1F7ED]/45">Exemplos de sinais possíveis</p>
        {examples.map((example, index) => <div key={example} className="flex items-center gap-5 border-t border-[#E0EEC6]/12 py-5">
  ...
  return <section className="bg-[#1b3028] px-5 py-24 sm:px-8 lg:py-32" aria-labelledby="before-after-title">
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-[.85fr_1.15fr] lg:gap-12">
        <div className="rounded-[26px] border border-[#E0EEC6]/15 p-6 sm:p-8">
        ...
        <div>
          <div className="mb-6 rounded-[26px] border border-[#7CA982]/35 bg-[#243E36] p-6 sm:p-8">
...
export function Trust() {
  return <section className="bg-[#14251f] px-5 py-24 sm:px-8 lg:py-28" aria-labelledby="trust-title">
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-12 grid border-t border-[#E0EEC6]/20 md:grid-cols-3">
        {principles.map(([title, copy], index) => <div key={title} className="border-b border-[#E0EEC6]/15 py-7 md:border-b-0 md:px-7 md:first:pl-0 md:last:pr-0">
          <span className="text-xs text-[#C2A83E]">0{index + 1}</span>
...
export function FinalCTA() {
  return <section className="relative overflow-hidden bg-[#102019] px-5 py-28 text-center sm:px-8 lg:py-40" aria-labelledby="final-cta-title">
    <div className="pointer-events-none absolute left-1/2 top-1/2 size-[550px] max-w-full -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#7CA982]/[.08] blur-[110px]" />
    <div className="relative mx-auto max-w-5xl">
      ...
      <Link href={signupHref} className="mt-10 inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-[#E0EEC6] px-7 text-sm font-bold text-[#243E36] transition-colors hover:bg-[#F1F7ED] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#E0EEC6]">Começar no Revyza <ArrowUpRight className="size-4" aria-hidden="true" /></Link>
    </div>
  </section>
}

export function Footer() {
  return <footer className="border-t border-[#E0EEC6]/10 bg-[#102019] px-5 py-10 sm:px-8">
